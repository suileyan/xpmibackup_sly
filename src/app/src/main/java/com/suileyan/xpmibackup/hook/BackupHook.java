...
public class BackupHook {
    ...
    /** 保护 activeBackupInProgress + activeBackupDirs 的复合操作（HIGH-14） */
    private static final Object BACKUP_DIR_LOCK = new Object();
     ...
     * 复合操作（置标志 + 加入集合）在锁内完成，避免与清理流程竞态（HIGH-14）
     */
